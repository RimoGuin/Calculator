...
text_display = Entry(tk_calc, font=('Cascadia Code', 20), textvariable=text_input,
...
# Powers of 10
tens_powers = Button(tk_calc, button_params, text='10^x', font=('Cascadia Code', 15),
...
log_base10 = Button(tk_calc, button_params, text='log\u2081\u2080', font=('Cascadia Code', 16),
...
delete_one = Button(tk_calc, bd=5, fg='#000', font=('Cascadia Code', 20),
              text='DEL', command=button_delete, bg='#db701f').grid(row=6, column=3, sticky="nsew")
delete_all = Button(tk_calc, bd=5, fg='#000', font=('Cascadia Code', 20),
...
exp = Button(tk_calc, button_params_main, text='EXP', font=('Cascadia Code', 16),
